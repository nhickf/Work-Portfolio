...
### Hello, I am an Android Developer from Philippines, always follow best practices for android application and I am always ready to learn new technologies, methods, and principle as per the project requirements.


# Porcelain Skin

Porcelain App is appointment scheduler and e-commerce application

<a href='"https://play.google.com/store/apps/details?id=com.porcelain.customerapp"'><img alt='Get it on Google Play' src='https://play.google.com/intl/en_us/badges/images/generic/en_badge_web_generic.png' height='80px'/></a>



### Technolgies :  Android SDK,Kotlin,Realm.DB,MVVM Architecture,Stripe,Retrofit,Rxjava.

<p align="center">
<img src="https://play-lh.googleusercontent.com/7dYQ0EMJoCLuf_B5Z_3czedcROuAuCgi_sOpvVqLwBiog0mcmasaL4_nikcrie54ySg=w240-h480-rw" width="250" height = "500"  title="Storyfy Application">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</p>
